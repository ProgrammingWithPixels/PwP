...
var $MQb = class {
  ...
  register(def) {
    if (this.a[def.scopeName]) {
      ...
      if (!$rh(existingRegistration.location, def.location)) {
...
var $NQb = "No TM Grammar registered for this language.";
var $OQb = class extends $9c {
...
function $7d(options, computeFn) {
  return new $$d(new $hd(options.owner, options.debugName, options.debugReferenceFn), computeFn, void 0, void 0, options.onLastObserverRemoved, options.equalsFn ?? $qd);
}
$ce($7d);
var DerivedState;
...
function $7D(languageId, state) {
  const tokens = new Uint32Array(2);
  tokens[0] = 0;
  tokens[1] = (languageId << 0 | 0 << 8 | 0 << 11 | 1 << 15 | 2 << 24) >>> 0;
  return new $8u(tokens, state === null ? $5D : state);
}
...
var $8D = class {
  ...
  insert(insertIndex, insertCount) {
    ...
    this.a = $7b(this.a, insertIndex, arr);
  }
};
...
var $Vu = class _$Vu {
  ...
  forEach(cb) {
    ...
    for (const tokenInfo of this.a) {
      const range = new $eu(lengthSum, lengthSum + tokenInfo.length);
      cb(range, tokenInfo);
  ...
  slice(range) {
    ...
    for (const tokenInfo of this.a) {
      ...
      if (tokenEndEx > range.start) {
        ...
        result.push(new $Wu(tokenInfo.length - deltaBefore - deltaAfter, tokenInfo.metadata));
      }
      lengthSum += tokenInfo.length;
    }
    return _$Vu.create(result);
  }
};
var $Wu = class {
...
var $Xu = class {
  ...
  add(length, metadata) {
    this.a.push(new $Wu(length, metadata));
  }
  build() {
    return $Vu.create(this.a);
  }
};
...
var $Yu = class _$Yu {
  static createEmpty(lineContent, decoder) {
    const defaultMetadata = _$Yu.defaultTokenMetadata;
    const tokens = new Uint32Array(2);
    tokens[0] = lineContent.length;
    tokens[1] = defaultMetadata;
    return new _$Yu(tokens, lineContent, decoder);
  }
  static createFromTextAndMetadata(data, decoder) {
    ...
    return new _$Yu(new Uint32Array(tokens), fullText, decoder);
  }
  ...
  getLanguageId(tokenIndex) {
    const metadata = this.a[(tokenIndex << 1) + 1];
    const languageId = $Qu.getLanguageId(metadata);
    return this.languageIdCodec.decodeLanguageId(languageId);
  }
  getStandardTokenType(tokenIndex) {
    const metadata = this.a[(tokenIndex << 1) + 1];
    return $Qu.getTokenType(metadata);
  }
  getForeground(tokenIndex) {
    const metadata = this.a[(tokenIndex << 1) + 1];
    return $Qu.getForeground(metadata);
  }
  getClassName(tokenIndex) {
    const metadata = this.a[(tokenIndex << 1) + 1];
    return $Qu.getClassNameFromMetadata(metadata);
  }
  getInlineStyle(tokenIndex, colorMap) {
    const metadata = this.a[(tokenIndex << 1) + 1];
    return $Qu.getInlineStyleFromMetadata(metadata, colorMap);
  }
  getPresentation(tokenIndex) {
    const metadata = this.a[(tokenIndex << 1) + 1];
    return $Qu.getPresentationFromMetadata(metadata);
  }
  ...
  findTokenIndexAtOffset(offset) {
    return _$Yu.findIndexInTokensArray(this.a, offset);
  }
  inflate() {
    return this;
  }
  ...
  */
  withInserted(insertTokens) {
    ...
    return new _$Yu(new Uint32Array(newTokens), text, this.languageIdCodec);
  }
  getTokensInRange(range) {
    const builder = new $Xu();
    ...
    for (let tokenIndex = startTokenIndex; tokenIndex <= endTokenIndex; tokenIndex++) {
      const tokenRange = new $eu(this.getStartOffset(tokenIndex), this.getEndOffset(tokenIndex));
...
var $1u = new Uint32Array(0).buffer;
var $2u = class _$2u {
  static deleteBeginning(lineTokens, toChIndex) {
    if (lineTokens === null || lineTokens === $1u) {
      return lineTokens;
    }
    return _$2u.delete(lineTokens, 0, toChIndex);
  }
  static deleteEnding(lineTokens, fromChIndex) {
    if (lineTokens === null || lineTokens === $1u) {
      return lineTokens;
    }
    const tokens = $3u(lineTokens);
    const lineTextLength = tokens[tokens.length - 2];
    return _$2u.delete(lineTokens, fromChIndex, lineTextLength);
  }
  static delete(lineTokens, fromChIndex, toChIndex) {
    if (lineTokens === null || lineTokens === $1u || fromChIndex === toChIndex) {
      return lineTokens;
    }
    const tokens = $3u(lineTokens);
    ...
    const fromTokenIndex = $Yu.findIndexInTokensArray(tokens, fromChIndex);
  ...
  static append(lineTokens, _otherTokens) {
    ...
    const myTokens = $3u(lineTokens);
    const otherTokens = $3u(_otherTokens);
  ...
  static insert(lineTokens, chIndex, textLength) {
    ...
    const tokens = $3u(lineTokens);
    const tokensCount = tokens.length >>> 1;
    let fromTokenIndex = $Yu.findIndexInTokensArray(tokens, chIndex);
    if (fromTokenIndex > 0) {
...
var $4u = class _$4u {
  static deserialize(buff, offset, result) {
    ...
    const startLineNumber = $0e(buff, offset);
    offset += 4;
    const count = $0e(buff, offset);
    offset += 4;
    const tokens = [];
    for (let i = 0; i < count; i++) {
      const byteCount = $0e(buff, offset);
      offset += 4;
      tokens.push(view32.subarray(offset / 4, offset / 4 + byteCount / 4));
      offset += byteCount;
    }
    result.push(new _$4u(startLineNumber, tokens));
    return offset;
  }
  /**
  ...
  getLineRange() {
    return new $gu(this.a, this.a + this.b.length);
  }
  /**
   * @see {@link b}
   */
  ...
  serialize(destination, offset) {
    $$e(destination, this.a, offset);
    offset += 4;
    $$e(destination, this.b.length, offset);
    offset += 4;
    for (let i = 0; i < this.b.length; i++) {
      const lineTokens = this.b[i];
      if (!(lineTokens instanceof Uint32Array)) {
      ...
      $$e(destination, lineTokens.byteLength, offset);
      offset += 4;
  ...
  applyEdit(range, text) {
    const [eolCount, firstLineLength] = $Uu(text);
    this.c(range);
    this.d(new $9t(range.startLineNumber, range.startColumn), eolCount, firstLineLength);
  }
  c(range) {
    ...
    if (firstLineIndex === lastLineIndex) {
      this.b[firstLineIndex] = $2u.delete(this.b[firstLineIndex], range.startColumn - 1, range.endColumn - 1);
      return;
    }
    if (firstLineIndex >= 0) {
      this.b[firstLineIndex] = $2u.deleteEnding(this.b[firstLineIndex], range.startColumn - 1);
      if (lastLineIndex < this.b.length) {
        const lastLineTokens = $2u.deleteBeginning(this.b[lastLineIndex], range.endColumn - 1);
        this.b[firstLineIndex] = $2u.append(this.b[firstLineIndex], lastLineTokens);
        this.b.splice(firstLineIndex + 1, lastLineIndex - firstLineIndex);
      } else {
        this.b[firstLineIndex] = $2u.append(this.b[firstLineIndex], null);
        this.b = this.b.slice(0, firstLineIndex + 1);
      }
    } else {
      const deletedBefore = -firstLineIndex;
      this.a -= deletedBefore;
      this.b[lastLineIndex] = $2u.deleteBeginning(this.b[lastLineIndex], range.endColumn - 1);
  ...
  d(position, eolCount, firstLineLength) {
    ...
    if (eolCount === 0) {
      this.b[lineIndex] = $2u.insert(this.b[lineIndex], position.column - 1, firstLineLength);
      return;
    }
    this.b[lineIndex] = $2u.deleteEnding(this.b[lineIndex], position.column - 1);
    this.b[lineIndex] = $2u.insert(this.b[lineIndex], position.column - 1, firstLineLength);
  ...
  e(insertIndex, insertCount) {
    ...
    this.b = $7b(this.b, insertIndex, lineTokens);
  }
};
...
var $9D = class {
  static deserialize(buff) {
    ...
    const result = [];
    for (let i = 0; i < count; i++) {
      offset = $4u.deserialize(buff, offset, result);
    }
    return result;
  }
  constructor() {
  ...
  add(lineNumber, lineTokens) {
    ...
    this.a.push(new $4u(lineNumber, [lineTokens]));
  }
  finalize() {
    return this.a;
  }
  ...
  c(destination) {
    let offset = 0;
    $$e(destination, this.a.length, offset);
    offset += 4;
    for (let i = 0; i < this.a.length; i++) {
...
var $_D = class {
  ...
  setEndState(lineNumber, state) {
    if (!state) {
      throw new $pb("Cannot set null/undefined state");
    }
    this.b.delete(lineNumber);
    const r = this.a.setEndState(lineNumber, state);
    if (r && lineNumber < this.d) {
      this.b.addRange(new $eu(lineNumber + 1, lineNumber + 2));
    }
    return r;
  }
  acceptChange(range, newLineCount) {
    ...
    this.b.addRangeAndResize(new $eu(range.startLineNumber, range.endLineNumberExclusive), newLineCount);
  }
  acceptChanges(changes) {
    for (const c of changes) {
      const [eolCount] = $Uu(c.text);
      this.acceptChange(new $gu(c.range.startLineNumber, c.range.endLineNumber + 1), eolCount + 1);
    }
  }
  invalidateEndStateRange(range) {
    this.b.addRange(new $eu(range.startLineNumber, range.endLineNumberExclusive));
  }
  ...
  getFirstInvalidLine(initialState) {
    ...
    if (!startState) {
      throw new $pb("Start state must be defined");
    }
...
var $bE = class {
  ...
  removeMin() {
    ...
    if (range.start + 1 === range.endExclusive) {
      ...
      this.a[0] = new $eu(range.start + 1, range.endExclusive);
    }
    return range.start;
  }
  delete(value) {
    ...
    if (idx !== -1) {
      ...
      if (range.start === value) {
        if (range.endExclusive === value + 1) {
          ...
          this.a[idx] = new $eu(value + 1, range.endExclusive);
        }
      } else {
        if (range.endExclusive === value + 1) {
          this.a[idx] = new $eu(range.start, value);
        } else {
          this.a.splice(idx, 1, new $eu(range.start, value), new $eu(value + 1, range.endExclusive));
        }
      }
    }
  }
  addRange(range) {
    $eu.addRange(range, this.a);
  }
  addRangeAndResize(range, newLength) {
    ...
    if (idxFirstMightBeIntersecting === idxFirstIsAfter) {
      const newRange = new $eu(range.start, range.start + newLength);
      if (!newRange.isEmpty) {
      ...
      const newRange = new $eu(start, endEx + delta);
      if (!newRange.isEmpty) {
...
var $KQb = class extends $9c {
  ...
  tokenizeEncoded(line, hasEOL, state) {
    ...
    const sw = shouldMeasure ? new $we(true) : void 0;
    ...
    if (textMateResult.stoppedEarly) {
      ...
      return new $8u(textMateResult.tokens, state);
    }
    if (this.g) {
...
var $PQb = class extends $Sw {
  ...
  retokenize(startLineNumber, endLineNumberExclusive) {
    if (this.m) {
      this.m.store.invalidateEndStateRange(new $gu(startLineNumber, endLineNumberExclusive));
      this.q.schedule();
    }
  }
  async v() {
    ...
    if (r.grammar) {
      const tokenizationSupport = new $LQb(this.u, new $KQb(r.grammar, r.initialState, false, void 0, () => false, (timeMs, lineLength, isRandomSample) => {
        this.s.reportTokenizationTime(timeMs, languageId, r.sourceExtensionId, lineLength, isRandomSample);
      }, false), $9c.None, this.o);
      this.m = new $0D(this.b.length, tokenizationSupport);
    } else {
      this.m = null;
    }
    this.w();
  ...
  async w() {
    ...
    if (!this.p) {
      const { diffStateStacksRefEq } = await $Mq("vscode-textmate", "release/main.js");
      this.p = diffStateStacksRefEq;
    }
    const startTime = (/* @__PURE__ */ new Date()).getTime();
    while (true) {
      let tokenizedLines = 0;
      const tokenBuilder = new $9D();
      ...
      while (true) {
        ...
        $Yu.convertToEndOffset(r.tokens, text.length);
...
var $QQb = class _$QQb {
  ...
  static getChannel(workerServer) {
    return workerServer.getChannel(_$QQb.CHANNEL_NAME);
  }
  static setChannel(workerClient, obj) {
    workerClient.setChannel(_$QQb.CHANNEL_NAME, obj);
  }
};
...
var TextMateTokenizationWorker = class {
  constructor(workerServer) {
    ...
    this.a = $QQb.getChannel(workerServer);
  }
  ...
  async f(grammarDefinitions, onigurumaWASMUri) {
    const vscodeTextmate = await $Mq("vscode-textmate", "release/main.js");
    const vscodeOniguruma = await $Mq("vscode-oniguruma", "release/main.js");
  ...
  $acceptNewModel(data) {
    ...
    const that = this;
    this.b.set(data.controllerId, new $PQb(uri, data.lines, data.EOL, data.versionId, {
...
// out-build/vs/workbench/services/textMate/browser/backgroundTokenization/worker/textMateTokenizationWorker.worker.esm.js
$DY(create);
